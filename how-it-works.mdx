...
<Steps>
  <Step title="Connect and deposit">
    Sign in with your email or connect a wallet. b1nary creates a smart wallet for you. Deposit USDC, ETH, or cbBTC from your external wallet. All trades execute from this wallet with zero gas fees.
  </Step>
