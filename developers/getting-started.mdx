...
**App users** sign in via email or wallet. b1nary creates a smart wallet that handles approvals and execution with zero gas fees. Users deposit funds to their smart wallet and trade from the UI.

**Agents and integrators** interact directly with the contracts using an EOA. This is the path described below.
